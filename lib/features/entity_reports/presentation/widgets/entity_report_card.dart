...
class EntityReportCardsStrip extends StatelessWidget {
  ...
  final List<CommunityModel> entities;
  final void Function(CommunityModel entity) onReport;
  static const String _defaultReportButtonHex = '#0D1B3E';

  static Color _accentFromEntity(CommunityModel entity) {
    final hex = entity.reportButtonColor;
...
class EntityReportCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final codePoint =
        entity.iconCodePoint ?? CommunityIconCatalog.defaultIconCodePoint;
...
List<EntityReportType> parseEntityReportAlertTypes(CommunityModel entity) {
  return entity.reportAlertTypes;
}
