...
class _CommunityMembersViewState extends State<CommunityMembersView>
  ...
  List<CommunityMemberListItem> _members = [];
  ...
  Future<void> _promoteToAdmin(CommunityMemberListItem member) async {
    final l10n = AppLocalizations.of(context)!;
    final confirmed = await _showConfirmDialog(
      title: l10n.promoteToAdmin,
      message: l10n.promoteQuestion(member.userName),
    ...
    if (success) {
      _showSnackBar(l10n.nowAdmin(member.userName), isSuccess: true);
      _loadMembers();
    } else {
  ...
  Future<void> _removeMember(CommunityMemberListItem member) async {
    final l10n = AppLocalizations.of(context)!;
    final confirmed = await _showConfirmDialog(
      title: l10n.expelMember,
      message: l10n.expelConfirmation(member.userName),
    ...
    if (success) {
      _showSnackBar(l10n.userExpelled(member.userName), isSuccess: true);
      _loadMembers();
    } else {
  ...
  Future<void> _reportMember(CommunityMemberListItem member) async {
    final l10n = AppLocalizations.of(context)!;
    final reason = await _showReportDialog(member.userName);
  ...
  void _showMemberActions(CommunityMemberListItem member) {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (member.userEmail.toString().isNotEmpty)
                            Text(
                              member.userEmail,
                              style: TextStyle(
                                fontSize: 14,
  ...
  void _showAddMemberSheet() {
    ...
    List<UserSearchHit> searchResults = [];
    ...
    showDialog(
      ...
      builder: (dialogContext) => Dialog(
        ...
        child: StatefulBuilder(
          ...
          Future<void> addUser(UserSearchHit user) async {
  ...
  Widget _buildMemberTile(CommunityMemberListItem member,
