...
class NotificationService {
  ...
  /// Envía notificación push cuando se crea una nueva alerta (solo iOS)
  Future<void> sendAlertNotification(AlertModel alert) async {
    try {
      // Solo enviar push notifications en iOS
      if (Platform.isIOS) {
      ...
      // En Android, las notificaciones se manejan localmente en HomeController y BackgroundService
    } catch (e) {
